		...
		switch (_p1.ctor) {
			case 'NewGame':
				return {
					...
					_1: _user$project$RenderHtml$getEntries
				};
			case 'Mark':
...
var _user$project$RenderHtml$generateRandomNumber = A2(
	_elm_lang$core$Random$generate,
	function (num) {
		return _user$project$RenderHtml$NewRandom(num);
	},
...
var _user$project$RenderHtml$main = _elm_lang$html$Html$program(
	{
